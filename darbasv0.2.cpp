...
void IvedimasIsFailo(vector<Studentas>& A);	//Duomen? skaitymo iš failo funkcija
double Vidurkis(vector<int>& paz);			//Vidurkio skai?iavimo funkcija
double Mediana(vector<int>& paz);			//Medianos skai?iavimo funkcija
void Isvedimas(vector<Studentas> A);		//Duomen? išvedimo funkcija
...
//Duomen? skaitymo iš failo funkcija
void IvedimasIsFailo(vector<Studentas>& A) {
	int failas;
